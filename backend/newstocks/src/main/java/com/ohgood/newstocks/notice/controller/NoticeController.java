...
public class NoticeController {
    ...
    public ResponseEntity<NoticeInsertResDto> insertNotice(
        @ModelAttribute NoticeInsertReqDto noticeInsertReqDto, Authentication authentication) {
        return new ResponseEntity<>(noticeService.insertNotice(noticeInsertReqDto, Long.parseLong(
    ...
    public ResponseEntity<NoticeInsertResDto> updateNotice(@PathVariable Long id,
        @ModelAttribute NoticeUpdateReqDto noticeUpdateReqDto, Authentication authentication) {
        return new ResponseEntity<>(
            noticeService.updateNotice(noticeUpdateReqDto, id, Long.parseLong(
                authentication.getName())),
            HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> deleteNotice(@PathVariable Long id,
        ...
        return new ResponseEntity<>(noticeService.deleteNotice(id, Long.parseLong(
