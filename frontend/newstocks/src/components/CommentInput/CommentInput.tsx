...
export default function CommentInput({ type='comment', func=null }: Props) {
  return (
      ...
      <div className={styles["input-box"]}>
        ...
        <div className={styles["button-box"]}>
          <div className={styles["submit-comment"]}>
            <button onClick={func ? func : () => null} className={styles["submit-button"]}>{type=='comment' ? '🧹 초기화' : '🗑 취소'}</button>
          </div>
          <div className={styles["submit-comment"]}>
