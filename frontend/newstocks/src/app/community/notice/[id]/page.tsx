  ...
  return (
    <div className={styles["main"]}>
      ...
      <div className={styles["paragraph"]}>
        ...
        <div>주식정보📈, 뉴스📰,  오답노트📑 기록일지📚를 한데 모은</div>
        <div>NEWStocks에서 좋은 주식투자 습관을 길러보세요!</div>
      </div>

      <div className={styles["paragraph"]}>
        <div style={{ fontSize: "25px", fontWeight: "550"}}><span style={{ color: "#4FE7B0" }}>NEWStocks</span>를 사용하면?</div>
      ...
      <div className={styles["paragraph"]}>
        <div>
          <div>서비스를 이용하시면서 게시물을 작성하시거나, 관심 종목을 등록하시고 아래의 간단한 설문에 참여해주시면 <br/>
            <span style={{ textDecoration: "underline"}}>랜덤으로 10분께 스타벅스 아메리카노 기프티콘을 드립니다!</span></div>
          <a className={styles["link"]} href='https://forms.gle/7vjF5fRJEExfTLZg9'>폼 작성 바로가기 →</a>
        </div>
...
응답이 늦어질수도 있는 점 양해 부탁 드립니다!</div>
          <a className={styles["link"]} href='https://open.kakao.com/o/sYsFZsKf'>문의하기 →</a>
        </div>
      </div>
    </div>
  )
